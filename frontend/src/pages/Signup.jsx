  ...
  return (
    <div className="w-full h-screen bg-white relative">
      ...
      <div className="w-full h-full flex items-center justify-center">
        <form onSubmit={handleSignup} className="w-[90%] max-w-[400px] shadow-2xl p-6 flex flex-col gap-4">
          ...
          <p className='text-center mb-10 cursor-pointer' onClick={() => navigate("/login")}>
